...
**Goals:**
- Understand and implement a minimal and realistic environmental robotics pipeline: **robot motion → pose/odometry → pollution sensing → heatmap mapping → visualization**
- Since this is a learning project, I will also be documenting a **notes** folder with my takeaways from each of the phases (see below).
